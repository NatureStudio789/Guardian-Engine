...
namespace GE
{
	...
	void GWireframeInstance::InitializeWireframeInstance(const Data& data)
	{
		...
		auto& WireframeTechnique = GTechnique::CreateNewTechnique("Wireframe", "debug", false);
	...
	GWireframe::GWireframe(const Data& data, std::string renderGraphName)
	{
		this->InitializeWireframe(data, renderGraphName);
	}
	...
	void GWireframe::InitializeWireframe(const Data& data, std::string renderGraphName)
	{
